export const copy = {
  ar: {
    ...
    chatbot: {
      title: "المساعد الذكي للابتكار",
      subtitle: "واجهة محادثة تجريبية تساعدك على استكشاف التحديات، صياغة الأفكار، وتجهيز طلبات التقديم آليًا دون استخدام النموذج اليدوي.",
      welcome:
        "مرحبًا، أنا مساعد الابتكار. يمكنني تلخيص التحديات الحالية، اقتراح أفكار مناسبة، أو إنشاء طلب تقديم فكرة أو تحدٍ جديد بصياغة جاهزة.",
      placeholder: "اكتب سؤالك أو اطلب مني تقديم فكرة أو تحدٍ جديد...",
      send: "إرسال",
      sending: "جارٍ الإرسال",
      thinking: "أفكر في أفضل رد مناسب لك الآن...",
      errorMessage: "تعذر الوصول إلى خدمة الذكاء الاصطناعي حالياً. تأكد من مفتاح OpenAI والفوترة ثم حاول مرة أخرى.",
      quickPrompts: [
        "ما هي التحديات المفتوحة الآن؟",
        "اقترح لي فكرة لهذا التحدي",
        "أنشئ طلب تقديم فكرة جديد",
      ],
      capabilitiesTitle: "ما الذي يمكنني فعله؟",
      capabilities: [
        "عرض ملخص سريع لأهم التحديات المفتوحة.",
        "اقتراح أفكار مرتبطة بالتحدي المختار.",
        "تجهيز طلب تقديم فكرة أو تحدٍ جديد بصيغة جاهزة.",
      ],
      recentTitle: "طلبات تم إنشاؤها عبر المساعد",
      emptyState: "لا توجد طلبات مرسلة عبر المساعد بعد.",
      submittedIdea: "تم تجهيز طلب فكرة جديد وإرساله تجريبيًا.",
      submittedChallenge: "تم تجهيز طلب تحدٍ جديد وإرساله تجريبيًا.",
      ideaType: "طلب فكرة",
      challengeType: "طلب تحدٍ",
      assistantLabel: "المساعد",
      userLabel: "أنت",
      exploreLabel: "تحديات مقترحة",
      suggestionLabel: "فكرة مقترحة",
    },
    admin: {
  ...
  en: {
    ...
    chatbot: {
      title: "Innovation AI Chatbot",
      subtitle: "A conversational assistant that helps users discover challenges, shape ideas, and submit guided requests instead of relying only on manual forms.",
      welcome:
        "Hello, I’m the Innovation Assistant. I can summarize active challenges, suggest ideas, and prepare a draft challenge or idea submission for this prototype.",
      placeholder: "Ask about challenges, ideas, or tell me to submit a request...",
      send: "Send",
      sending: "Sending",
      thinking: "Thinking through the best response for you...",
      errorMessage: "The AI service is unavailable right now. Check the OpenAI API key and billing, then try again.",
      quickPrompts: [
        "What challenges are open right now?",
        "Suggest an idea for this challenge",
        "Create a new idea submission",
      ],
      capabilitiesTitle: "What can I do?",
      capabilities: [
        "Summarize the active challenge pipeline.",
        "Suggest ideas tailored to a selected challenge.",
        "Prepare and submit a draft idea or challenge request.",
      ],
      recentTitle: "Requests Created Through AI",
      emptyState: "No AI-generated requests have been submitted yet.",
      submittedIdea: "A new idea request was drafted and submitted in this prototype.",
      submittedChallenge: "A new challenge request was drafted and submitted in this prototype.",
      ideaType: "Idea Request",
      challengeType: "Challenge Request",
      assistantLabel: "Assistant",
      userLabel: "You",
      exploreLabel: "Suggested Challenges",
